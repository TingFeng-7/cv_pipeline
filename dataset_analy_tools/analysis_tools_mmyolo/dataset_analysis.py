...
# python tools/analysis_tools/dataset_analysis.py custom_config/yolox_s_swin-tiny_e300_Dior.py --output-dir dataset_analysis/dior 每个数据集的分布
def parse_args():
